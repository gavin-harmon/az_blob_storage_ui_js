...
class BlobService:
    ...
    async def list_files(self, prefix: str = "") -> List[dict]:
        try:
            ...
            # Combine base_directory with additional prefix
            ...
            for blob in blobs:
                relative_path = blob.name[len(full_prefix):] if full_prefix else blob.name
                ...
                if '/' in relative_path:
                    ...
                    dir_path = (full_prefix + dir_name + '/') if full_prefix else (dir_name + '/')
